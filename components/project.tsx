...
export default function Project({
  ...
  return (
    ...
    >
      <section className=" bg-gray-100 max-w-[42rem] border-black/5 overflow-hidden sm:pr-8  rounded-lg relative sm:h-[20rem] mb-3 sm:mb-8 last:mb-0 even:pl-8 hover:bg-gray-200 transition sm:group-even:pl-8 dark:bg-white/10 dark:hover:bg-white/20 dark:text-white">
